Kawra Core version 0.16.1 is now available from:

  <https://bitcoincore.org/bin/kawra-core-0.16.1/>
...
- #12843 `df38b13` Test starting kawrad with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure kawrad processes are cleaned up when tests end (sdaftuar)
