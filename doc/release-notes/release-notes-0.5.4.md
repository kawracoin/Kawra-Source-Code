Kawra version 0.5.4 is now available for download at:
http://sourceforge.net/projects/kawra/files/Kawra/kawra-0.5.4/
...
http://gitorious.org/kawra/kawrad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Kawra-Qt notifications under Growl 1.3.
Increase required age of Kawra-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxKawra properly when installing Kawra-Qt over it. (Windows)
