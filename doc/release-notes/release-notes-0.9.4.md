Kawra Core version 0.9.4 is now available from:

  https://kawra.org/bin/0.9.4/
...
this update is incompatible with the Kawra system and could lead to consensus
forks.

Kawra Core released binaries from https://kawra.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~kawra/+archive/ubuntu/kawra
- A third-party or self-compiled Kawra Core

upgrade to Kawra Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
