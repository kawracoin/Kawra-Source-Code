Kawra Core version *0.15.2* is now available from:

  <https://bitcoincore.org/bin/kawra-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in kawra-tx (TheBlueMatt)
