...
Kawra Core version 0.19.1 is now available from:

  <https://bitcoincore.org/bin/kawra-core-0.19.1/>
...
From Kawra Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Kawra Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Kawra Core does not yet change appearance when
...
- #17488 fix "kawrad already running" warnings on macOS (fanquake)
