Kawra Core version 0.9.2.1 is now available from:

  https://kawra.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 KAWRA to 0.01 KAWRA
...
- Fix "Start kawra on system login"
