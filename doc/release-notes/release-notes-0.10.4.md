Kawra Core version 0.10.4 is now available from:

  <https://kawra.org/bin/kawra-core-0.10.4/>
...
- #6953 `43c2789` Split kawra-tx into its own package
- #6953 `dfe0d4d` Include kawra-tx binary on Debian/Ubuntu
