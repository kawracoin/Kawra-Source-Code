Kawra Core version 0.13.2 is now available from:

  <https://kawra.org/bin/kawra-core-0.13.2/>
...
- #8908 `4a974b2` Update kawra-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow kawra-tx to create v2 transactions (kawradrak)
