Download URL: https://sourceforge.net/projects/kawra/files/Kawra/kawra-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 KAWRA fee schedule (users still pay 0.01 KAWRA per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #kawra00 - #kawra99
