Kawra-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/kawra/files/Kawra/kawra-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Kawra
...
New/changed settings (command-line or kawra.conf file)
--------------------------------------------------------
