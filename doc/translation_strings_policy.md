...
This document provides guidelines for internationalization of the Kawra Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kawra_en.ts` remains unchanged.
