# Bootstrappable Kawra Core Builds

This directory contains the files necessary to perform bootstrappable Kawra
Core builds.
...
To build Kawra Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Kawra Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/kawra-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/kawra-core/guix.sigs).
