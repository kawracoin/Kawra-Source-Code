...
Arguments:
    <base_directory> - The base directory of a kawra source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Kawra Core developers'
...
Arguments:
    <file> - A source file in the kawra repository.
"""
