...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef KAWRA_CHAINPARAMSSEEDS_H\n')
    g.write('#define KAWRA_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the kawra network\n')
    ...
    g.write('#endif // KAWRA_CHAINPARAMSSEEDS_H\n')
