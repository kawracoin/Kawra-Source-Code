...
complete --command kawrad --no-files

# Extract options
function __fish_kawrad_get_options
...
complete \
    --command kawrad \
    --arguments "(__fish_kawrad_get_options --nofiles)"
