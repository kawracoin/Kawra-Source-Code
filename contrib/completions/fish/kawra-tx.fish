...
# Extract options
function __fish_kawra_tx_get_options
...
# Extract commands
function __fish_kawra_tx_get_commands
...
complete \
    --command kawra-tx \
    --condition "not __fish_kawra_seen_cmd (__fish_kawra_tx_get_commands --commandsonly)" \
    --arguments "(__fish_kawra_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command kawra-tx \
    --arguments "(__fish_kawra_tx_get_commands)" \
    --no-files
