...
"""Example logging Kawra Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/kawrad
...
def main(kawrad_path):
    ...
    b = BPF(text=program, usdt_contexts=[kawrad_with_usdts])
