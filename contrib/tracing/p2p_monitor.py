...
""" Interactive kawrad P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Kawra Core can enable. It uses BCC
...
def main(kawrad_path):
    ...
    kawrad_with_usdts.enable_probe(
