...
"""Verify that starting kawra with -h works as expected."""

from test_framework.test_framework import KawraTestFramework
from test_framework.util import assert_equal

class HelpTest(KawraTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kawra with -h for help text")
        ...
        self.log.info("Start kawra with -version for version information")
        ...
        self.log.info("Start kawrad with -fakearg to make sure it does not start")
