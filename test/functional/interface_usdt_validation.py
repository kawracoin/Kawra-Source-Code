...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/kawra/kawra/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(KawraTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/kawra/kawra/blob/master/doc/tracing.md#tracepoint-validationblock_connected
