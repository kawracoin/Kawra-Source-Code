...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the KawraTestFramework
    pass


class ExampleTest(KawraTestFramework):
    # Each functional test is a subclass of the KawraTestFramework class.
    ...
    def custom_method(self):
        ...
        KawraTestFramework class so other tests can use it."""
