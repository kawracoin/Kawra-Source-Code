...
class TransactionTimeRescanTest(KawraTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine KAWRA and create transactions
        ...
        # generate some kawra to create transactions and check blockcount
        ...
        # send 10 kawra to user's first watch-only address
        self.log.info('Send 10 kawra to user')
        ...
        # send 5 kawra to our second watch-only address
        self.log.info('Send 5 kawra to user')
        ...
        # send 1 kawra to our third watch-only address
        self.log.info('Send 1 kawra to user')
