...
class TestShell:
    """Wrapper Class for KawraTestFramework.

    The TestShell class extends the KawraTestFramework
    ...
    class __TestShell(KawraTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by KawraTestFramework child class.
            self.num_nodes = 1
