...
By default, kawrad will dump mempool on shutdown and
...
class MempoolPersistTest(KawraTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent kawrad from writing mempool.dat to disk. Verify that `savemempool` fails")
