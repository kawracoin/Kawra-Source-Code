...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/kawra/kawra/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(KawraTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our kawrad node")
