...
class TxnMallTest(KawraTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 KAWRA:
        ...
        # First: use raw transaction API to send 1240 KAWRA to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 KAWRA coin each
        ...
        # Node0's balance should be starting balance, plus 50KAWRA for another
        ...
        # Node0's total balance should be starting balance, plus 100KAWRA for
