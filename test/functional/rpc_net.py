...
class NetTest(KawraTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=23918)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 23918)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=23918), {"success": False})
