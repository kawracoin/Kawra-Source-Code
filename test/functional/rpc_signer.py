...
Verify that a kawrad node can use an external signer command.
...
class RPCSignerTest(KawraTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart kawrad with -signer=<cmd>',
