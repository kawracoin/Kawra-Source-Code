...
#ifndef KAWRA_TEST_SCRIPTNUM10_H
#define KAWRA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Kawra Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // KAWRA_TEST_SCRIPTNUM10_H
