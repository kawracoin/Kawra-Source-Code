...
{
    BOOST_CHECK(TestSplitHost("www.kawracore.org", "www.kawracore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.kawracore.org]", "www.kawracore.org", 0));
    BOOST_CHECK(TestSplitHost("www.kawracore.org:80", "www.kawracore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.kawracore.org]:80", "www.kawracore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:23918", "127.0.0.1", 23918));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:23918", "127.0.0.1", 23918));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:23918", "::ffff:127.0.0.1", 23918));
    BOOST_CHECK(TestSplitHost("[::]:23918", "::", 23918));
    BOOST_CHECK(TestSplitHost("::23918", "::23918", 0));
    BOOST_CHECK(TestSplitHost(":23918", "", 23918));
    BOOST_CHECK(TestSplitHost("[]:23918", "", 23918));
    ...
    BOOST_CHECK(TestSplitHost("www.kawracore.org:65536", "www.kawracore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.kawracore.org:0", "www.kawracore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.kawracore.org:", "www.kawracore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:23918", "127.0.0.1:23918"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:23918", "[::]:23918"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
