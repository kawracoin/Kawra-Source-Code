...
#ifndef KAWRA_INTERFACES_NODE_H
#define KAWRA_INTERFACES_NODE_H
...
//! Top-level interface for a kawra node (kawrad process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or kawra.conf.
