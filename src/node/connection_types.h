...
#ifndef KAWRA_NODE_CONNECTION_TYPES_H
#define KAWRA_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/kawra-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Kawra’s Peer-to-Peer Network")
...
#endif // KAWRA_NODE_CONNECTION_TYPES_H
