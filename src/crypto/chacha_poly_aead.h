...
#ifndef KAWRA_CRYPTO_CHACHA_POLY_AEAD_H
#define KAWRA_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@kawra.
 *
 ...
 *
 * The chacha20-poly1305@kawra combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@kawra cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@kawra are relatively fast in
...
#endif // KAWRA_CRYPTO_CHACHA_POLY_AEAD_H
