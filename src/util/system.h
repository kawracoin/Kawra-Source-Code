 ...
 */
#ifndef KAWRA_UTIL_SYSTEM_H
#define KAWRA_UTIL_SYSTEM_H
...
extern const char * const KAWRA_CONF_FILENAME;
extern const char * const KAWRA_SETTINGS_FILENAME;
