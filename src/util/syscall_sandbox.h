...
#ifndef KAWRA_UTIL_SYSCALL_SANDBOX_H
#define KAWRA_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during kawrad initialization if Kawra Core was compiled
...
#endif // KAWRA_UTIL_SYSCALL_SANDBOX_H
