      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->kawraAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->kawraAtStartup);
    ...
    ui->kawraAtStartup->setToolTip(ui->kawraAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->kawraAtStartup->setText(ui->kawraAtStartup->text().arg(PACKAGE_NAME));

    ui->openKawraConfButton->setToolTip(ui->openKawraConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new KawraUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->kawraAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSKAWRAontrols);
...
void OptionsDialog::on_openKawraConfButton_clicked()
{
