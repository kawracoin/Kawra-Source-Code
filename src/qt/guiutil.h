...
#ifndef KAWRA_QT_GUIUTIL_H
#define KAWRA_QT_GUIUTIL_H
...
/** Utility functions used by the Kawra Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "kawra:" URI into recipient object, return true on successful parsing
