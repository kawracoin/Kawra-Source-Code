...
//! Entry point for KawraApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &KawraApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for KawraGUI tests.
void AppTests::guiTests(KawraGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &KawraGUI::consoleShown, this, &AppTests::consoleTests);
