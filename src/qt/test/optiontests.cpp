...
{
    // Test regression https://github.com/kawra/kawra/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/kawra-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/kawra-core/gui/pull/568.
    // With fListen=false in ~/.config/Kawra/Kawra-Qt.conf and all else left as default,
    // kawra-qt should set both -listen and -listenonion to false and start successfully.
