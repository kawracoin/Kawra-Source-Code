...
#ifndef KAWRA_RPC_PROTOCOL_H
#define KAWRA_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in kawrad
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Kawra is not connected
