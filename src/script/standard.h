...
#ifndef KAWRA_SCRIPT_STANDARD_H
#define KAWRA_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a kawra address
 */
...
/**
 * Generate a Kawra scriptPubKey for the given CTxDestination. Returns a P2PKH
