...
#ifndef KAWRA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define KAWRA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // KAWRA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
