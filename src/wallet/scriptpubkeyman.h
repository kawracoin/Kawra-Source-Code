...
#ifndef KAWRA_WALLET_SCRIPTPUBKEYMAN_H
#define KAWRA_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Kawra Core wallet was originally a collection of unrelated private
...
#endif // KAWRA_WALLET_SCRIPTPUBKEYMAN_H
