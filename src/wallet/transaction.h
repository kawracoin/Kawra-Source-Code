...
#ifndef KAWRA_WALLET_TRANSACTION_H
#define KAWRA_WALLET_TRANSACTION_H
...
public:
     ...
     * on this kawra node, and set to 0 for transactions that were created
...
#endif // KAWRA_WALLET_TRANSACTION_H
