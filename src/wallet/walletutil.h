...
#ifndef KAWRA_WALLET_WALLETUTIL_H
#define KAWRA_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! kawra from opening the wallet, thinking it was newly created, and
...
#endif // KAWRA_WALLET_WALLETUTIL_H
